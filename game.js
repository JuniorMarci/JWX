...
function drawPlatforms() {
    ...
    //var gradient = ctx.createLinearGradient(platform.x, platform.y, platform.x, platform.y + platform.height);
    ...
    gradient.addColorStop(1, "#04A24E");  // Cor no fim do gradiente
